...
public final class SqlHandler {
    ...
    private SqlHandler(String dbUrl, String dbUser, String dbPassword, Logger logger) {
        this.DB_URL = dbUrl;
        this.DB_USER = dbUser;
    ...
    public static synchronized SqlHandler getInstance(String dbUrl, String dbUser, String dbPassword, Logger logger) {
        if (instance == null) {
            instance = new SqlHandler(dbUrl, dbUser, dbPassword, logger);
        }
        return instance;
    }
